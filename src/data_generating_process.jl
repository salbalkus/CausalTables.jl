...
function _parse_tilde(expr)
    ...
    elseif expr.args[1] == :~
        return expr.args[2] => eval(:((; O...) -> $(_parse_distribution(expr.args[3]))))
    else
...
function _get_conditional_distribution(varfunc::NeighborSum, dgp::DataGeneratingProcess, ct::CausalTable)
